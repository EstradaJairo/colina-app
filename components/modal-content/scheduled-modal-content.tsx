            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    id="status"
                    className="block w-[300px] h-12 rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6"
