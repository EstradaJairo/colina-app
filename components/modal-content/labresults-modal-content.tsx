          ...
          <div className="h-[600px] max-h-[400px] md:px-10 mt-5">
            <div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
              ...
              <div className="relative">
                <label
                  htmlFor="fileUpload"
                  className="relative h-12 w-full bg-[#daf3f5] border-[#007C85] border-dashed border-2 flex justify-center items-center rounded-md cursor-pointer text-center text-[#101828] font-bold mt-[33px] transition duration-300 ease-in-out hover:bg-[#b2e2e4]"
                >
                  <Image
                  ...
                  <div className="flex pb-5 text-nowrap text-[12px] ">
                    ...
                    <label
                      htmlFor="imageUpload"
                      className="underline decoration-solid text-blue-500 ml-1 mt-2 cursor-pointer"
                    >
                      Browse
                    </label>
                  </div>
