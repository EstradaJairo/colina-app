...
const FileUploadWithHover = () => {
  ...
  return (
    ...
    >
      ...
      />
      {isHovering && (
        <div className="absolute bg-[#4E4E4E] p-2 text-white border rounded-md shadow-md bottom-[-90px] left-0">
      ...
      <div className="">
        <div className="justify-center flex border-t-4 pt-26">
          <button
            onClick={() => isModalOpen(false)}
            type="button"
            className="w-[600px] h-[50px] px-3 py-2  bg-[#F3F3F3] hover:text-red-500 font-medium text-black mt-4 mr-[3px] rounded-bl-md"
          >
            Cancel
          </button>
          <button
