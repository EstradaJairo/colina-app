...
export const Modal = ({ label, isOpen, isModalOpen }: Modalprops) => {
  ...
  return (
    <div
      className={`absolute inset-[-100px] bg-[#76898A99] flex items-center justify-center pb-[266px]`}
    >
        ...
        <div className=" mb-9 pt-4">
          <div className="h-[600px] max-h-[300px] md:px-10 mt-5">
            <form className="">
              ...
              <div className="mt-8 pb-3 flex grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                <button
