            ...
            <div className="fixed z-50 bg-white rounded-[10px] shadow-xl w-[650px] mx-auto p-[55px] mb-[320px]">
              ...
              <div className="mx-auto mb-5 text-gray-400 w-[110px] h-[110px]">
                ...
                <p className=" text-[24px] text-sm text-gray-400 mb-10"
                  > Your data has been successfully added.</p>
              
  <button
  onClick={() => setModalOpen(true)} // Set isModalOpen to false to close the modal
  className="text-white bg-[#1B84FF] hover:bg-blue-800 font-medium rounded-lg 
             text-[26px] w-[330px] px-[31px] py-[18px] me-2 mx-2 dark:bg-blue-600 dark:hover:bg-blue-700"
>
  Okay, Thanks!
</button>
              </div>
